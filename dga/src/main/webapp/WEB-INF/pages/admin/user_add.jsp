	...
	$(function(){
		...
		$('#save').click(function(){
			...
			$('#form').submit();
				...
				$.messager.alert("温馨提示","请输入要添加的用户信息！","warning");
			}
		});
	});
</script>	
...
<body class="easyui-layout" style="visibility:hidden;">
    ...
    <div region="center" style="overflow:auto;padding:5px;" border="false">
       <form id="form" action="${pageContext.request.contextPath }/savaSystemUser.action" method="post" >
           <table class="table-edit"  width="95%" align="center">
				...
				<tr>
	           	...
	           	<tr>
		           	<td>角色:</td>
		           	<td colspan="3" id="roleList">
		           		<script type="text/javascript">
		           			//发送ajax请求获取所有角色数据，展示为复选框
		           			var url = "${pageContext.request.contextPath}/getRoleList.action";
		           			$.post(url,{},function(data){
		           				for(var i=0;i<data.length;i++){
		           					var id = data[i].id;
		           					var name = data[i].name;
		           					$("#roleList").append("<input value='"+id+"' name='roleIds' type='checkbox'>" + name);
		           				}
		           			});
		           		</script>
		           	</td>
