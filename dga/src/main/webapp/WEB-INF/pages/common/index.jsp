...
<script type="text/javascript">
	...
	function logoutFun() {
		...
		.confirm('系统提示','您确定要退出本次登录吗?',function(isConfirm) {
			if (isConfirm) {
				location.href = '${pageContext.request.contextPath }/login_out.action';
			}
		});
	}
	// 修改密码
	...
	// 版权信息
	function showAbout(){
		$.messager.alert("互动中心","管理员邮箱: hanzq@mapuni.cn");
	}
</script>
</head>
<body class="easyui-layout">
	<!-- <div data-options="region:'north',border:false"
		...
		<div> -->
	<div data-options="region:'north',border:false"
		style="height:80px;padding:10px;background:url('') no-repeat right;">
		<div>
		<!-- 去掉logo -->
	...
	<!-- <div data-options="region:'south',border:false"
		...
		<div data-options="region:'south',border:false"
		style="height:50px;padding:10px;background:url('') no-repeat right;">
		<table style="width: 100%;">
			<tbody>
				<tr>
					<td style="width: 300px;">
						<div style="color: #999; font-size: 8pt;">
							中科宇图 | Powered by <a href="#">地图院:Hanzq</a>
						</div>
					</td>
