...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#btn").click(function(){
			//使用工具方法将form表单序列化为json格式的数据，作为查询条件
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="分区添加修改" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="saveForm" 
				action="${pageContext.request.contextPath }/subareaAction_save.action" method="post">
					...
					<tr>
						...
						<td>
    						...
    						data-options="valueField:'id',
    							textField:'name',url:'${pageContext.request.contextPath }/regionAction_findListByAjax.action'" />
						</td>
					</tr>
					<tr>
						<td>关键字</td>
